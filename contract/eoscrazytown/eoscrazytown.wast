(module
 ...
 (data (i32.const 1312) "must buy a positive amount\00")
 (data (i32.const 1344) "error memo\00")
 (data (i32.const 1360) "stake\00")
 (data (i32.const 1376) "must use true CTN to stake\00")
 (data (i32.const 1408) "make_profit\00")
 (data (i32.const 1424) "must use true EOS to make profit\00")
 (data (i32.const 1472) "must use CTN to stake\00")
 (data (i32.const 1504) "must use EOS to make profit\00")
 (data (i32.const 1536) "must stake a positive amount\00")
 (data (i32.const 1568) "don\'t have enough CMU for unstake\00")
 (data (i32.const 1616) "transfer token by unstake\00")
