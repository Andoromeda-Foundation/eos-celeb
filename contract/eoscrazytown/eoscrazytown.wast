(module
 ...
 (data (i32.const 912) "receipt\00")
 (data (i32.const 928) "Winner Winner Chicken Dinner. \00")
 (data (i32.const 960) "Better Luck Next Time\00")
 ...
 (data (i32.const 1248) "XXXXXXXXXXX\00")
 (data (i32.const 1264) "Invalid token transfer...\00")
 (data (i32.const 1296) "buy\00")
 (data (i32.const 1312) "not correct time.\00")
 (data (i32.const 1344) "no enough eos\00")
 (data (i32.const 1360) "cannot buy with yourself\00")
 (data (i32.const 1392) "refund\00")
 (data (i32.const 1408) "ref bonus\00")
 (data (i32.const 1424) "next hodl\00")
 (data (i32.const 1440) "Bets not equal to amount.\00")
