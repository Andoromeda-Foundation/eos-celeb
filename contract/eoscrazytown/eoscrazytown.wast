(module
 ...
 (data (i32.const 1424) "must have bets in memo\00")
 (data (i32.const 1456) "memo should not < 76\00")
 (data (i32.const 1488) "Bets not equal to amount.\00")
 (data (i32.const 1520) "Bets should not < 0.1\00")
 (data (i32.const 1552) "Bets should not > 20\00")
 (data (i32.const 1584) "winninetysix\00")
 (data (i32.const 1600) "for proxy\00")
 (data (i32.const 1616) "for refer\00")
 (data (i32.const 1632) "unable to find key\00")
 (data (i32.const 1664) "only EOS token is allowed\00")
 (data (i32.const 1696) "wrong size\00")
    ...
    (block $label$101
     (block $label$102
      (block $label$103
       ...
       (call $_ZN5eosio11multi_indexILy12415831931030077440EN12eoscrazytown6playerEJEE6modifyIZNS1_10onTransferEyyNS_14extended_assetENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEE3$_3EEvRKS2_yOT_
        (get_local $10)
        (get_local $5)
        (get_local $2)
        (i32.add
      ...
      (call $_ZZN5eosio11multi_indexILy12415831931030077440EN12eoscrazytown6playerEJEE7emplaceIZNS1_10onTransferEyyNS_14extended_assetENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEE3$_2EENS3_14const_iteratorEyOT_ENKUlRSF_E_clINS3_4itemEEEDaSH_
       (i32.add
        (get_local $14)
        (i32.const 80)
       )
 ...
 (func $_ZN12eoscrazytown4initERK11checksum256 (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  ...
  (call $_ZN5eosio9singletonILy7235159537265672192EN7council9st_globalEE13get_or_createEyRKS2_
   (i32.add
    (get_local $7)
    (i32.const 80)
   )
 ...
 (func $_ZN5eosio9singletonILy7235159537265672192EN7council9st_globalEE13get_or_createEyRKS2_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (i32.store offset=4
   (i32.const 0)
  ...
  (block $label$0
   ...
   (call $_ZN5eosio11multi_indexILy7235159537265672192ENS_9singletonILy7235159537265672192EN7council9st_globalEE3rowEJEE7emplaceIZNS4_13get_or_createEyRKS3_EUlRS5_E_EENS6_14const_iteratorEyOT_
    (get_local $5)
    (get_local $1)
    (get_local $2)
    (i32.add
 ...
 (func $_ZN5eosio11multi_indexILy7235159537265672192ENS_9singletonILy7235159537265672192EN7council9st_globalEE3rowEJEE7emplaceIZNS4_13get_or_createEyRKS3_EUlRS5_E_EENS6_14const_iteratorEyOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZZN5eosio11multi_indexILy12415831931030077440EN12eoscrazytown6playerEJEE7emplaceIZNS1_10onTransferEyyNS_14extended_assetENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEE3$_2EENS3_14const_iteratorEyOT_ENKUlRSF_E_clINS3_4itemEEEDaSH_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5eosio11multi_indexILy12415831931030077440EN12eoscrazytown6playerEJEE6modifyIZNS1_10onTransferEyyNS_14extended_assetENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEE3$_3EEvRKS2_yOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
  (local $7 i64)
