(module
 ...
 (data (i32.const 176) "not the owner...\00")
 ...
 (data (i32.const 816) "singleton does not exist\00")
 (data (i32.const 848) "active\00")
 (data (i32.const 864) "receipt\00")
 (data (i32.const 880) "Winner Winner Chicken Dinner. \00")
 (data (i32.const 912) "Better Luck Next Time\00")
 ...
 (data (i32.const 1200) "XXXXXXXXXXX\00")
 (data (i32.const 1216) "crazytown.bp\00")
 (data (i32.const 1232) "Invalid token transfer...\00")
 (data (i32.const 1264) "buy\00")
 (data (i32.const 1280) "no character exist\00")
 (data (i32.const 1312) "no enough eos\00")
 (data (i32.const 1328) "refund\00")
 (data (i32.const 1344) "ref bonus\00")
 (data (i32.const 1360) "next hodl\00")
 (data (i32.const 1376) "Bets not equal to amount.\00")
 (data (i32.const 1408) "Already bet.\00")
 (data (i32.const 1424) "only EOS token is allowed\00")
 (data (i32.const 1456) "must buy a positive amount\00")
            ...
            (block $label$17
             (block $label$18
              (block $label$19
               ...
               (call $_ZZN5eosio11multi_indexILy12415831931030077440EN12eoscrazytown6playerEJEE7emplaceIZNS1_10onTransferERyS5_RNS_5assetERNSt3__112basic_stringIcNS8_11char_traitsIcEENS8_9allocatorIcEEEEE3$_3EENS3_14const_iteratorEyOT_ENKUlRSI_E_clINS3_4itemEEEDaSK_
                (i32.add
                 (get_local $19)
                 (i32.const 24)
                )
 ...
 (func $_ZN5eosio11multi_indexILy7235159537265672192ENS_9singletonILy7235159537265672192EN12eoscrazytown9st_globalEE3rowEJEE7emplaceIZNS4_13get_or_createEyRKS3_EUlRS5_E_EENS6_14const_iteratorEyOT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy7235159537265672192ENS_9singletonILy7235159537265672192EN12eoscrazytown9st_globalEE3rowEJEE7emplaceIZNS4_13get_or_createEyRKS3_EUlRS5_E_EENS6_14const_iteratorEyOT_ENKUlRSD_E_clINS6_4itemEEEDaSF_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
 ...
 (func $_ZZN5eosio11multi_indexILy7235159537265672192ENS_9singletonILy7235159537265672192EN12eoscrazytown9st_globalEE3rowEJEE7emplaceIZNS4_13get_or_createEyRKS3_EUlRS5_E_EENS6_14const_iteratorEyOT_ENKUlRSD_E_clINS6_4itemEEEDaSF_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (i32.store offset=4
   (i32.const 0)
 ...
 (func $_ZZN5eosio11multi_indexILy12415831931030077440EN12eoscrazytown6playerEJEE7emplaceIZNS1_10onTransferERyS5_RNS_5assetERNSt3__112basic_stringIcNS8_11char_traitsIcEENS8_9allocatorIcEEEEE3$_3EENS3_14const_iteratorEyOT_ENKUlRSI_E_clINS3_4itemEEEDaSK_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
